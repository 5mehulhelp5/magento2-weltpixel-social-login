...
class Analytics
{
    ...
    protected function _countItems() {
        ...
        $sql =
            ...
            "SELECT SUM(total_item_count) as items FROM " . $tableName ." WHERE state NOT IN('pending_payment', 'canceled') " . $this->condition;
    ...
    protected function _countAllOrdersItems() {
        ...
        $sql =
            // phpcs:ignore Magento2.SQL.RawQuery.FoundRawSql
            "SELECT SUM(total_item_count) as items FROM " . $tableName ." WHERE state NOT IN('pending_payment', 'canceled')";
        $result = $connection->fetchOne($sql);
    ...
    protected function _getRevenue()
    {
        ...
        $sql =
            // phpcs:ignore Magento2.SQL.RawQuery.FoundRawSql
            "SELECT SUM(base_grand_total) as revenue FROM " . $tableName ." WHERE state NOT IN('pending_payment', 'canceled') " . $this->condition;
        $result = $connection->fetchOne($sql);
    ...
    protected function _getTotalRevenues() {
        ...
        $sql =
            // phpcs:ignore Magento2.SQL.RawQuery.FoundRawSql
            "SELECT SUM(base_grand_total) as revenue FROM " . $tableName ." WHERE state NOT IN('pending_payment', 'canceled')";
        $result = $connection->fetchOne($sql);
